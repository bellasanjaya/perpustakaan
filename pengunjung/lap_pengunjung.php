...
<tr><td class="head-data">No</td><td class="head-data">Nama</td><td class="head-data">JK</td><td class="head-data">Pekerjaan</td><td class="head-data">Perlu</td><td class="head-data">Saran</td></tr>
<?php
$no=0;
...
//akhir
$ta=mysql_num_rows(mysql_query("SELECT * FROM pengunjung WHERE kelas='SD' AND tgl_kunjung LIKE '%$bulan%'"));
$tb=mysql_num_rows(mysql_query("SELECT * FROM pengunjung WHERE kelas='SMP' AND tgl_kunjung LIKE '%$bulan%'"));
$tc=mysql_num_rows(mysql_query("SELECT * FROM pengunjung WHERE kelas='SMA' AND tgl_kunjung LIKE '%$bulan%'"));
$g=mysql_num_rows(mysql_query("SELECT * FROM pengunjung WHERE kelas='Guru' AND tgl_kunjung LIKE '%$bulan%'"));
$k=mysql_num_rows(mysql_query("SELECT * FROM pengunjung WHERE kelas='Mahasiswa' AND tgl_kunjung LIKE '%$bulan%'"));
...
<tr><td class='pinggir-data'>SD</td><td align="center" class='td-data'><b><?php echo $ta; ?></b></td></tr>
<tr><td class='pinggir-data'>SMP</td><td align="center" class='td-data'><b><?php echo $tb; ?></b></td></tr>
<tr><td class='pinggir-data'>SMA</td><td align="center" class='td-data'><b><?php echo $tc; ?></b></td></tr>
<tr><td class='pinggir-data'>Guru</td><td align="center" class='td-data'><b><?php echo $g; ?></b></td></tr>
<tr><td class='pinggir-data'>Mahasiwa</td><td align="center" class='td-data'><b><?php echo $k; ?></b></td></tr>
